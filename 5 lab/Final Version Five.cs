...
// Clase para manter el dia y la localidad guardadas
...
class HW5
{
    ...
    // Estructura que lee un archivo .txt y lo convierte a un evento de dia y lugar
    ...
    public static void Main(string[] args)
    {
        ...
        string filename = @"C:\Users\David\Downloads\tests\input4.txt";
